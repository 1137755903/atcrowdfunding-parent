...
<head>
    ...
    <!-- 包含指令属于java代码。以斜线开头就表示上下文路径了。如果再增加上下文表达式就会出现重复上下文路径。 -->
...
<div class="container">
    ...
    <form id="loginForm" class="form-signin" role="form" action="${PATH}/login" method="post">
        ...
        <div class="form-group has-success has-feedback">
            <input type="text" class="form-control" id="inputSuccess4" name="loginacct" value="zhangsan" placeholder="请输入登录账号" autofocus>
